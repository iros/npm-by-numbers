define(function(require){
  ...
  var questionTemplates = {
    ageyears: require('tmpl!../templates/questions/ageyears'),
    maintainers: require('tmpl!../templates/questions/maintainers'),
    releases: require('tmpl!../templates/questions/releases'),
    versions: require('tmpl!../templates/questions/versions'),
    updated: require('tmpl!../templates/questions/updated'),
    top_5_deep_dependents: require('tmpl!../templates/questions/top_5_deep_dependents')
  };
